...
sealed class SecureStore {
  const SecureStore._();

  static final _key = encrypt.Key.fromBase64('rYae08sKaGbK9rl/iPDOlgQxtF9kxOzTY0vBce1WYoY=');
  ...
  static String readUsingDecryption<T extends PreferenceEntry<String>>(T entry) {
    try {
      ...
      _logDecryptionError(entry: entry, error: 'Invalid base64 format', details: e.toString());
      return '';
    } on Object catch (e) {
      _logDecryptionError(entry: entry, error: 'Decryption failed', details: e.toString());
      return '';
    }
  }
